...
Resource catalog, `publish-resource`, workspace approval, workspace setup, and workspace gate APIs are available in published `onlyharness@0.2.10` and through MCP/HTTP.
