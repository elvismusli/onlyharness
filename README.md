...
Resource catalog, `publish-resource`, workspace approval, workspace setup, workspace gate APIs, and membership expiry handling are available in published `onlyharness@0.2.11` and through MCP/HTTP.
