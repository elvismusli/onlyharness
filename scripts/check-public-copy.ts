...
check(docs["apps/registry-web/src/skins/superskill/pages/DocsPage.tsx"].includes("superskillInstallHandoff") && docs["apps/registry-web/src/skins/superskill/pages/AgentGuidePage.tsx"].includes("superskillInstallHandoff"), "SuperSkill HTML docs must read the generated runtime contract through the fail-closed install handoff");
